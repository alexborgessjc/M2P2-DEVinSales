...
namespace DevInSales.Api.Controllers
{
    ...
    public class AddressController : ControllerBase
    {
        ...
        public async Task<ActionResult> AddAddressAsync(int stateId, int cityId, AddAddress model)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<ActionResult> UpdateAddressAsync(int addressId, UpdateAddress model)
        {
            var address = await _addressService.GetById(addressId);
            if (address == null)
                return NotFound();
